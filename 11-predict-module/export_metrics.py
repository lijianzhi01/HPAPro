...
def load_data_from_prometheus(start_time_str, end_time_str, pattern, metric='container_cpu_usage_seconds_total'):  
    ...
    file_name = "./data/{}-{}-{}.csv".format(pattern, metric, datetime.now().strftime('%y%m%d-%H%M%S'))  
...
if __name__ == "__main__":  
    ...
    parser.add_argument("--metric", type=str, help="Metric for the output file name")  
    args = parser.parse_args()  
  
    load_data_from_prometheus(args.start_time, args.end_time, args.pattern, args.metric)  
